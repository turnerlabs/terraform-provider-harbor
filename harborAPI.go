...
//GetShipment returns a top-level shipment
func GetShipment(username string, token string, name string) *Shipment {

	//build URI
	uri := shipitURI("/v1/shipment/{shipment}", param("shipment", name))
	if Verbose {
